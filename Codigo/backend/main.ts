...
import { route as AppointmentController } from './src/controllers/AppointmentController';
import { route as PatientController } from './src/controllers/PatientController';
import { route as AddressController } from './src/controllers/AddressController';
import { route as AnalyticsController } from './src/controllers/AnalyticsController';
...
app.use('/reports', AnalyticsController);
